...
La promoción usa el HTTP productivo oficial con excepción restringida, y queda condicionada a firma definitiva, E2E TEST/físico, backup verificado y smoke/rollback del runbook API. Esta preparación no autoriza SQL, deploy ni publicación productiva.
